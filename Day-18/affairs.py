# -*- coding: utf-8 -*-
"""
Created on Wed May 29 15:51:12 2019
...
print("percentage of women have affairs:",per.round())

listA=[3,25,3,1,4,16,4,2]
nd=np.array(listA)
nd=nd.reshape(1,8)
nd=onehotencoder.transform(nd).toarray()
